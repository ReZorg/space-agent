...
- module-local imports inside `llm.js`, `config.js`, and `skills.js` should stay relative so the same prompt-builder code remains directly importable in Node.js tests as well as browser `/mod/...` runtime loads
